...
function (_React$Component) {
  ...
  _createClass(FormItem, [{
    ...
    value: function renderLabel(prefixCls) {
      ...
      return React.createElement(FormContext.Consumer, null, function (_ref3) {
        ...
        var labelColClassName = classNames("".concat(prefixCls, "-item-label"), mergedLabelCol.className);
